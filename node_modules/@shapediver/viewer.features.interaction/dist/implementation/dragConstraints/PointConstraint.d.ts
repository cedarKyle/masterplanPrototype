 ...
 */
export declare class PointConstraint implements IDragConstraint {
    #private;
    /**
     ...
     */
    constructor(_point: vec3, _radius?: number, _rotation?: {
        axis: vec3;
        angle: number;
    });
...
//# sourceMappingURL=PointConstraint.d.ts.map