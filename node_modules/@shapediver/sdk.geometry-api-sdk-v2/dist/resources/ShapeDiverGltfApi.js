    ...
    upload(sessionId, body, type, queryConvert = api_geometry_api_dto_v2_1.ShapeDiverRequestGltfUploadQueryConversion.NONE) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, utils_1.sendRequest)(() => __awaiter(this, void 0, void 0, function* () {
                return (yield this.api.post(`${this.buildSessionUri(sessionId)}/gltf?conversion=${queryConvert}`, body, { contentType: type, responseType: sdk_geometry_api_sdk_core_1.ShapeDiverSdkApiResponseType.JSON }))[1];
            }));
        });
    }
}
